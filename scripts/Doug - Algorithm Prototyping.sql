...
/*** 2. STARTING POINT - A USER NAMED POLO */
# Interesting: Two reviewers of Phoenix restaurants with name "Polo": 
# dJCPmuMGFZoBJ9t89qnS0g  (2x)
# CHa6N1KJtRmspb_-5RRjAA  (3x)
SET @user = 'CHa6N1KJtRmspb_-5RRjAA';
SELECT b.id, b.name FROM business AS b JOIN phx_review AS r ON b.id = r.business_id WHERE r.user_id = @user;
# User 'Polo" has reviewed three restaurants:
# ZP7U4qUCMjIvasWV7a_mgg	Waffle House
# kBJfBVaXJtPEKLTov1hJdQ	Reathrey Sekong
# pTZ4u-sEQr-yHq2Cl4EMEw	T Cook's
